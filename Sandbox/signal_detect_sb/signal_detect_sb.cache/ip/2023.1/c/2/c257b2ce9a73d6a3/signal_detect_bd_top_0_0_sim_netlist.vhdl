...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sample_controller is
  ...
  signal \div_cnt[1]_i_2_n_0\ : STD_LOGIC;
  signal \div_cnt[1]_i_3_n_0\ : STD_LOGIC;
  signal \div_cnt[9]_i_1_n_0\ : STD_LOGIC;
  signal \div_cnt[9]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \sample_out[15]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \bram_addr[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \bram_addr[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \bram_addr[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \bram_addr[5]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \bram_addr[5]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \bram_addr[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \bram_addr[7]_i_2\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of bram_addr_reg_rep_i_11 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \div_cnt[1]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \div_cnt[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \div_cnt[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \div_cnt[9]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \sample_cnt[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \sample_cnt[10]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \sample_cnt[5]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sample_cnt[6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sample_cnt[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sample_cnt[8]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \sample_cnt[9]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \sample_out[15]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \sample_out[15]_i_3\ : label is "soft_lutpair5";
begin
...
active_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FBF0"
        ...
        port map (
      I0 => bram_addr_reg_rep_i_10_n_0,
      I1 => \sample_out[15]_i_1_n_0\,
      I2 => \div_cnt[9]_i_1_n_0\,
      I3 => active,
      O => active_i_1_n_0
    );
...
\bram_addr[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
        ...
        port map (
      I0 => \div_cnt[9]_i_1_n_0\,
      I1 => \sample_out[15]_i_1_n_0\,
      O => \bram_addr[7]_i_1_n_0\
    );
\bram_addr[7]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B040"
    )
        port map (
...
bram_addr_reg_rep_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \sample_out[15]_i_1_n_0\,
      I1 => \div_cnt[9]_i_1_n_0\,
      O => bram_addr_reg_rep_i_1_n_0
    );
bram_addr_reg_rep_i_10: unisim.vcomponents.LUT6
    generic map(
...
bram_addr_reg_rep_i_11: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
bram_addr_reg_rep_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"A6000000"
    )
        port map (
      I0 => bram_addr(7),
      I1 => bram_addr(6),
      I2 => \bram_addr[7]_i_3_n_0\,
      I3 => bram_addr_reg_rep_i_10_n_0,
      I4 => \sample_out[15]_i_1_n_0\,
      O => bram_addr_reg_rep_i_2_n_0
    );
bram_addr_reg_rep_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9000"
    )
        port map (
      ...
      I2 => bram_addr_reg_rep_i_10_n_0,
      I3 => \sample_out[15]_i_1_n_0\,
      O => bram_addr_reg_rep_i_3_n_0
    );
bram_addr_reg_rep_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9000"
    )
        port map (
...
bram_addr_reg_rep_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9000"
    )
        port map (
...
bram_addr_reg_rep_i_6: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => bram_addr(0),
      I3 => bram_addr(2),
      I4 => bram_addr_reg_rep_i_10_n_0,
      I5 => \sample_out[15]_i_1_n_0\,
      O => bram_addr_reg_rep_i_6_n_0
    );
bram_addr_reg_rep_i_7: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6A000000"
    )
        port map (
...
bram_addr_reg_rep_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6000"
    )
        port map (
...
bram_addr_reg_rep_i_9: unisim.vcomponents.LUT6
    generic map(
...
\div_cnt[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => div_cnt_reg(1),
      I1 => div_cnt_reg(0),
      I2 => \div_cnt[9]_i_3_n_0\,
      I3 => \div_cnt[1]_i_2_n_0\,
      I4 => div_cnt_reg(3),
      I5 => \div_cnt[1]_i_3_n_0\,
      O => \div_cnt[1]_i_1_n_0\
    );
\div_cnt[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => div_cnt_reg(4),
      I1 => div_cnt_reg(9),
      O => \div_cnt[1]_i_2_n_0\
    );
\div_cnt[1]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\div_cnt[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => sw(1),
      I5 => sw(0),
      O => \div_cnt[9]_i_1_n_0\
    );
\div_cnt[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => div_cnt_reg(4),
      I3 => div_cnt_reg(3),
      I4 => \div_cnt[9]_i_3_n_0\,
      I5 => div_cnt_reg(9),
      O => \p_1_in__0\(9)
    );
\div_cnt[9]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\sample_cnt[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\sample_out[15]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => div_cnt_reg(3),
      I5 => active,
      O => \sample_out[15]_i_1_n_0\
    );
\sample_out[15]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF7"
    )
        port map (
...
\sample_out[15]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
valid_prev_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0116"
    )
        port map (
...
\status_out[2]_INST_0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEE8"
    )
        port map (
